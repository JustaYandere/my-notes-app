...
export const SEED_NOTES = [
  ...
  { id: 8, title: 'Automatic backups', body: "Makinote quietly saves a full snapshot of your notes every 2 weeks, kept for about 2 months — separate from your synced data, so a sync problem can't take a backup down with it.\n\nFind it in Settings → Other: back up on demand, browse and restore past snapshots, or (Chrome/Edge only) point it at a folder on your device for an extra on-disk copy.", mode: 'note', checklist: [], pinned: false, hidden: false, tags: ['getting-started', 'tips'], color: 'c4', createdAt: Date.now() - 1000 * 60 * 60 * 24 * 2, updatedAt: Date.now() - 1000 * 60 * 60 * 24 * 2 },
  { id: 9, title: 'Moving notes in from another app', body: "Coming from ColorNote or another simple notepad app? If it can export your notes as plain text files, Settings → Other → \"Import notes (.txt files)\" brings in as many as you like at once — each file becomes its own note, added alongside what you already have (nothing gets replaced).\n\nConnected notes (shared with you or by you) now live in their own tab next to your notes instead of a popup — look for it at the top of the main screen once you're signed in.", mode: 'note', checklist: [], pinned: false, hidden: false, tags: ['getting-started', 'tips'], color: 'c1', createdAt: Date.now() - 1000 * 60 * 60 * 24, updatedAt: Date.now() - 1000 * 60 * 60 * 24 },
];
