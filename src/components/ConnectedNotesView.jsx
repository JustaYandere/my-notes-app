...
// Renders inline as the main content area's "Connected" tab, not as a
// popup/modal -- it shares the page's header, search, and settings icons
// with the regular notes tab instead of covering them.
export default function ConnectedNotesView({ syncUser, onOpen, onCreateForConnection, colorHexOf, text, muted, bg, borderStyle }) {
  ...
  if (!supabaseEnabled || !syncUser) {
    return <p style={{ fontSize: 13, color: muted }}>Sign in to share and co-edit notes with connected accounts.</p>;
  }
